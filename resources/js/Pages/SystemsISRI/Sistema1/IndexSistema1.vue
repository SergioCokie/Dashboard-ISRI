...
<template>
    ...
    <div class="flex h-screen overflow-hidden">
        <div id="sidebar"
            class="test lg:overflow-y-auto flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll  no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-[#1c1e4d] p-4 transition-all duration-200 ease-in-out -translate-x-64">
            <!-- Sidebar header -->

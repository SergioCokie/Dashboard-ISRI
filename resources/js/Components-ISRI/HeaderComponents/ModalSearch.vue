<template>
  ...
  <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0"
    ...
    <div v-show="showModalSearch" class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity"
      aria-hidden="true">
    </div>
  </transition>
  <!--// Modal backdrop -->
      ...
      <div class="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
        ...
        <div class="py-4 px-2">
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li><a aria-current="page" href="/#0"
                  class="router-link-active router-link-exact-active flex items-center p-2 text-slate-800 hover:text-white hover:bg-indigo-500 rounded group"><svg
          ...
          <div class="mb-3 last:mb-0">
            ...
            <ul class="text-sm">
              <li><a aria-current="page" href="/#0"
                  ...
                  </svg><span><span class="font-medium text-slate-800 group-hover:text-white">Messages</span> -
